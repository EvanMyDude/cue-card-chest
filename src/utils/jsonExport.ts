...
import { computeChecksum, dedupeByChecksum } from './mergePrompts';

/**
 * Export prompts to a JSON file and trigger download
 */
...
/**
 * Merge imported prompts with existing prompts, deduplicating by checksum
 */
